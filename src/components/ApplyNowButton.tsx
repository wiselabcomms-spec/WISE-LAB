...
export function ApplyNowButton() {
  ...
  return (
    <MotionLink
      ...
      whileTap={{ scale: 0.97 }}
      className="fixed bottom-6 left-6 z-40 flex h-14 items-center gap-2.5 rounded-full px-5 text-sm font-semibold text-plum bg-[#FF8A65] shadow-[0_4px_12px_-4px_rgba(255,138,101,0.35)]"
    >
